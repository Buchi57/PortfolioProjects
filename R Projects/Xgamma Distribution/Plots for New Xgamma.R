##Plots for the pdf of the New Xgamma distribution
par(mfrow=c(2,2))
y<-seq(0,15)
a1= 0.5
p1= ((a1^2/(1+a1))*((6+a1^2*y^3)/6)*exp(-y*a1))
a2= 0.4
p2= ((a2^2/(1+a2))*((6+a2^2*y^3)/6)*exp(-y*a2))
a3= 0.6
p3= ((a3^2/(1+a3))*((6+a3^2*y^3)/6)*exp(-y*a3))
a4= 0.05
p4= ((a4^2/(1+a4))*((6+a4^2*y^3)/6)*exp(-y*a4))
a5= 0.3
p5= ((a5^2/(1+a5))*((6+a5^2*y^3)/6)*exp(-y*a5))
plot(y,p1,type="l",col="red",ylab="g(y,"~eta~")",pch="*")
lines(y,p3,type="l",col="blue")
lines(y,p5,type="l",col="green")
lines(y,p4,type="l",col="black")
lines(y,p2,type="l",col="gold")
legend("topright",legend=c(expression(paste(~phi=="50.5")),expression(paste(~phi=="60.4")),expression(paste(~phi=="26.5")),expression(paste(~phi=="57.8")),expression(paste(~phi=="45.0"))),col=c("red","blue","green","black","purple"),lty=1:1:1:1:2,cex=0.8)
...
lines(y,p4,type="l",col="black")
lines(y,p2,type="l",col="gold")
legend("topright",legend=c(expression(paste(~phi=="0.07")),expression(paste(~phi=="0.04")),expression(paste(~phi=="0.09")),expression(paste(~phi=="0.05")),expression(paste(~phi=="0.03"))),col=c("red","blue","green","black","purple"),lty=1:1:1:1:2,cex=0.8)
